...
import { allSecretTreeValues, createSecretTree, decodeSecretTree, secretTreeEncoder } from "./secretTree.js";
...
export const groupStateEncoderWithoutTree = contramapBufferEncoders([
    groupContextEncoder,
    keyScheduleEncoder,
    secretTreeEncoder,
    privateKeyPathEncoder,
...
export const encodeGroupStateWithoutTree = encode(groupStateEncoderWithoutTree);
export function decodeGroupStateWithoutTree(ratchetTree) {
    return mapDecoders([
        decodeGroupContext,
        decodeKeySchedule,
        decodeSecretTree,
        ...
        decodeBigintMap(decodeEpochReceiverData),
        decodeGroupActiveState,
    ], (groupContext, keySchedule, secretTree, privatePath, signaturePrivateKey, unappliedProposals, confirmationTag, historicalReceiverData, groupActiveState) => ({
        groupContext,
        keySchedule,
        secretTree,
        ratchetTree,
