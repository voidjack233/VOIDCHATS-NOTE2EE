...
function buildStableFingerprintSeed(req: Request): string {
  return [
    req.get('User-Agent') || '',
...
export class DeviceFingerprint {
  ...
  static ensureFingerprint(req: Request, res: Response): string {
  ...
  static getDeviceCharacteristics(req: Request): DeviceCharacteristics {
  ...
  static detectBrowser(ua: string): string {
  ...
  static detectOS(ua: string): string {
