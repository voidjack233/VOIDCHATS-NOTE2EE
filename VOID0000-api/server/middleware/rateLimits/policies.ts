...
function deviceTokenBucket(policy: RateLimitPolicy): RateLimitPolicy {
  return {
...
function userTokenBucket(policy: RateLimitPolicy): RateLimitPolicy {
  return {
    algorithm: RATE_LIMIT_ALGORITHMS.TOKEN_BUCKET,
...
function authLockout(policy: RateLimitPolicy): RateLimitPolicy {
  return {
...
function multiBucket(policy: RateLimitPolicy): RateLimitPolicy {
  return {
