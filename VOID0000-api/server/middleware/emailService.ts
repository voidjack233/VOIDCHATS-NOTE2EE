...
const loadTemplate = (
  ...
  const templatePath = fromProjectRoot('server', 'utils', 'emails', `${templateName}.html`);
...
export class VerificationService {
  ...
  static async sendVerificationCodeToUser(
    ...
    try {
      ...
      const { success, code } = await this.createVerificationCode(client, user_id, email);
